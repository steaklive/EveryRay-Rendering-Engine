// simplified version of ForwardLighting.hlsl for rendering into light probes
...
float3 GetFinalPBRColor(VS_OUTPUT vsOutput, int forcedCascadeShadow = -1)
{
    ...
    float3 color = directLighting * shadow;
...
{
    return GetFinalPBRColor(vsOutput, -2);
}

float3 mainPS_PBR_SpecularProbes(VS_OUTPUT vsOutput) : SV_Target0
{
    return GetFinalPBRColor(vsOutput, NUM_OF_SHADOW_CASCADES - 1);
}

float3 mainPS_Empty(VS_OUTPUT vsOutput) : SV_Target0
{
...
technique11 renderToLightProbe_diffuse_probes
{
    pass p0
    {
...
technique11 renderToLightProbe_diffuse_probes_instancing
{
    pass p0
    {
...
technique11 renderToLightProbe_specular_probes
{
    pass p0
    {
        SetVertexShader(CompileShader(vs_5_0, mainVS()));
...
technique11 renderToLightProbe_specular_probes_instancing
{
    pass p0
    {
        SetVertexShader(CompileShader(vs_5_0, mainVS_Instancing()));
...
technique11 renderToLightProbe
{
    pass p0
    {
        SetVertexShader(CompileShader(vs_5_0, mainVS()));
        SetGeometryShader(NULL);
        SetPixelShader(CompileShader(ps_5_0, mainPS_Empty()));
    }
}

technique11 renderToLightProbe_instancing
{
    pass p0
    {
        SetVertexShader(CompileShader(vs_5_0, mainVS_Instancing()));
