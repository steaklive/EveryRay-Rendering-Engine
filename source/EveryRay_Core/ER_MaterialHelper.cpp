...
namespace EveryRay_Core
{
	...
	const std::string ER_MaterialHelper::fresnelOutlineMaterialName = "FresnelOutlineMaterial";
	const std::string ER_MaterialHelper::furShellMaterialName = "FurShellMaterial";
